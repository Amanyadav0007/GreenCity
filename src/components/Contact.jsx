...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "81be8fc6-e2c8-4195-b19d-0655cd02918c");
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
          <div className='w-full md:w-1/2 text-left'>
            Your Name
            <input type="text" name="Name" placeholder='Your Name' className='w-full border border-gray-300 rounded py-3 px-4 mt-2' required />
          </div>

          <div className='w-full md:w-1/2 text-left md:pl-4'>
            Your Email
            <input type="email" name="Email" placeholder='Your Email' className='w-full border border-gray-300 rounded py-3 px-4 mt-2' required />
          </div>
        </div>
